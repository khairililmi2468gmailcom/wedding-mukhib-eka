...
export default function Wishes() {
    ...
    const [wishes, setWishes] = useState([
        {
            id: 1,
            name: "Rahmat & Siti",
            message: "Selamat menempuh hidup baru, Mukhibuddin & Eka! Semoga cinta dan kebahagiaan selalu menyertai perjalanan kalian berdua. 💖",
        ...
        },
        {
            id: 2,
            name: "Dewi & Putra",
            message: "Barakallah, semoga pernikahan ini menjadi sakinah, mawaddah, dan warahmah. Doa terbaik untuk kalian berdua! 🤲",
        ...
        },
        {
            id: 3,
            name: "Ahmad Fauzan",
            message: "Semoga rumah tangga Mukhibuddin & Eka selalu dilimpahi keberkahan dan kebahagiaan. Aamiin. 🌹",
        ...
        },
        {
            id: 4,
            name: "Aisyah",
            message: "Selamat menempuh kehidupan baru! Semoga kalian selalu bersama dalam suka dan duka. 🕊️",
            timestamp: "2025-04-02T19:20:00Z",
            attending: "attending"
        },
        {
            id: 5,
            name: "Rizky & Anisa",
            message: "Semoga cinta kalian terus tumbuh dan pernikahan ini menjadi ladang pahala serta keberkahan. 🤍✨",
        ...
        },
        {
            id: 6,
            name: "Hafiz & Keluarga",
            message: "Mukhibuddin & Eka, semoga Allah SWT selalu menjaga dan melindungi rumah tangga kalian. Selamat berbahagia! 💕",
            timestamp: "2025-04-07T21:00:00Z",
            attending: "attending"
        }
    ]);
    ...
    return (<>
        <section id="wishes" className="relative flex flex-col items-center justify-center px-4 py-16 sm:py-20 text-center overflow-hidden bg-cover bg-center"
