...
export default function Gifts() {
    ...
    return (<>
        <section id="gifts" className="relative flex flex-col items-center justify-center px-4 py-16 sm:py-20 text-center overflow-hidden bg-cover bg-center"
            ...
            <div className="container mx-auto px-4 py-20 relative z-10">
                ...
                >
                    ...
                    >
                        ...
                        Doa restu dari keluarga dan sahabat adalah hadiah terbaik bagi kami.
</p>
